...
@implementation JDBaseRefreshManager{
    id<JDBaseScrollViewRefreshDelegate> _delegate;
}

+ (instancetype)shareInstance {
    static JDBaseRefreshManager *sharedInstance = nil;
...
- (void)registerRefreshView:(id<JDBaseScrollViewRefreshDelegate>)delegate {
    _delegate = delegate;
}
